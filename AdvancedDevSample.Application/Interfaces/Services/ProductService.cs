// ProductService.cs - VERSION REFACTORISÉE
using System;
...
namespace AdvancedDevSample.Application.Services
{
    ...
    public class ProductService : IProductService
    {
        ...
        public async Task<ProductDto> CreateAsync(CreateProductDto createDto)
        {
            ...
            await ValidateSupplierAsync(createDto.SupplierId);
            ...
            await SaveProductAsync(product, isNew: true);
        ...
        {
            _logger.LogInformation("Application d'une remise de {Discount}% sur le produit {ProductId}",
                discount * 100, id);
        ...
        public async Task DeleteAsync(Guid id)
        {
            ...
            await GetProductOrThrowAsync(id);
        ...
        private async Task ValidateSupplierAsync(Guid supplierId)
        {
            ...
            {
                throw new ValidationException("SupplierId", "Le fournisseur n'est pas actif");
            }
        }

        private async Task SaveProductAsync(Product product, bool isNew = false)
        {
            if (isNew)
            {
